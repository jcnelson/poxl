...
(define-public (mine-tokens-over-30-blocks (amount-ustx uint))
    (let
        ...
        (unwrap-panic (mine-tokens-at-block block-height miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u1) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u2) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u3) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u4) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u5) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u6) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u7) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u8) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u9) miner-id amount-ustx))

        (unwrap-panic (mine-tokens-at-block (+ block-height u10) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u11) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u12) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u13) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u14) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u15) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u16) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u17) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u18) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u19) miner-id amount-ustx))

        (unwrap-panic (mine-tokens-at-block (+ block-height u20) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u21) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u22) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u23) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u24) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u25) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u26) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u27) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u28) miner-id amount-ustx))
        (unwrap-panic (mine-tokens-at-block (+ block-height u29) miner-id amount-ustx))
        (ok true)
    )
)
